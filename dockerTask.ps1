...
.PARAMETER Clean
Removes the image mycodecamp and kills all containers based on that image.
...
Build a Docker image named mycodecamp
#>
...
$imageName="mycodecamp"
$projectName="mycodecamp"
$serviceName="mycodecamp"
